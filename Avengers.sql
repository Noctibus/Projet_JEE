...
(8, 'Stephen Strange', 'Docteur Strange', 'Benedict Cumberbatch', 'Stephen Strange neuro- chirurgien brillant mais égoïste, perd  suite à un accident de voiture la capacité d’opérer, recherchant dans le monde entier  un moyen de  réparer ses mains et il fait la rencontre de l’Ancien. Devenu son élève dans les arts mystiques, il lui succède comme Sorcier Suprême. ', 0, 0, 0, 0, 1, 3),
(9, 'Carol Danvers', 'Captain Marvel', 'Brie Larson', 'L\'ancienne pilote de l\'Air Force et agente de renseignement Carol Danvers a poursuivi son rêve d\'exploration spatiale en tant qu\'employée de la NASA, mais sa vie a changé à jamais lorsqu\'elle a été accidentellement transformée en un hybride humain-Kree doté de pouvoirs extraordinaires.', 0, 0, 0, 1, 1, 3),
