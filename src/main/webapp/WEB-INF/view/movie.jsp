	  	...
	  	<div class="box">
			...
			<div class="desc">
				<c:forEach var="i" begin="1" end="${rate}" step="1">
					<a href="/putMovieRate?value=${i}&movieId=${movie.id}" class="star" id="star${i}" style="color:red" onmouseover="mouseOver(id)" onmouseout="mouseOut(id,'${rate}')">&#9733</a>
				</c:forEach>
				<c:forEach var="i" begin="1" end="${5-rate}" step="1">
					<a href="/putMovieRate?value=${rate+i}&movieId=${movie.id}" class="star" id="star${rate+i}" onmouseover="mouseOver(id)" onmouseout="mouseOut(id,'${rate}')">&#9733</a>
				</c:forEach>
			</div>
        </div>
		<div class="comments">
